         ...
         <div class="card-body card-block">
             <form method="post" action="">
                 <div class="form-group">
                     ...
                     <input type="text" id="company" name="kode"  class="form-control" value="<?php echo $data;?>" readonly>
                 </div>
                 <div class="form-group">
                     <label for="vat" class=" form-control-label">kategori</label>
                     <select name="category_id" id="" class="form-control">
                         <?php foreach ($datacat as $dt){ ?>
                            <option value="<?php echo $dt['category_id']; ?>"><?php echo $dt['explanation']; ?> </option>
                         <?php } ?>
                     </select>
                 </div>
                 <div class="form-group">
                     ...
                     <select name="idsup" class="form-control">
                         <?php foreach ($datasup as $dt){ ?>
                            <option value="<?=$dt['idsup']; ?>"><?=$dt['namasup']; ?></option>
                         <?php } ?>
                     </select>
                 </div>
                 <div class="form-group">
                     <label for="vat" class=" form-control-label">Nama Barang</label>
                     <input type="text" id="vat" name="namabarang" placeholder="" class="form-control" required>
                 </div>
                 <div class="form-group">
                     <label for="vat" class=" form-control-label">stok</label>
                     <input type="text" id="vat" name="stok" value='0' placeholder="" class="form-control" required>
                 </div>
                 <div class="form-group">
                     <label for="vat" class=" form-control-label">harga beli</label>
                     <input type="text" id="vat" name="hrgbeli" value='0' placeholder="" class="form-control" required>
                 </div>
                 <div class="form-group">
                     <label for="vat" class=" form-control-label">harga jual</label>
                     <input type="text" id="vat" name="hrgjual" value='0' placeholder="" class="form-control" required>
                 </div>
